...
#error "No default keymap defined. You should make sure that you have a line like '#define PRIMARY_KEYMAP_QWERTY' in your sketch"
  ...
  (___,      Key_F1,                 Key_F2,                   Key_F3,                    Key_F4,                Key_F5,              Key_F6,
   ...
   ___,      XXX,                    XXX,                      Key_LeftBracket,           Key_LeftBracket,       XXX,                 XXX,
   ___,      Key_Delete,             Key_Delete,               ___,
   XXX,

   Key_F7,   Key_F8,                 Key_F9,                   Key_F10,                   Key_F11,               Key_F12,             ___,
   ___,      Key_Equals,             Key_Minus,                LSHIFT(Key_Comma),         LSHIFT(Key_Period),    XXX,                 ___,
  ...
  (___,      Key_F1,                 Key_F2,                   Key_F3,                    Key_F4,                Key_F5,             Key_F6,
   ___,      XXX,                    XXX,                      Key_LeftParen,             Key_RightParen,        LSHIFT(Key_1),      ___,
   ___,      XXX,                    XXX,                      Key_LeftCurlyBracket,      Key_RightCurlyBracket, LSHIFT(Key_Equals),
   ___,      XXX,                    XXX,                      Key_LeftBracket,           Key_RightBracket,      XXX,                XXX,
   ___,      Key_Delete,             Key_Delete,               ___,
   XXX,

   Key_F7,   Key_F8,                 Key_F9,                   Key_F10,                   Key_F11,               Key_F12,             ___,
   XXX,      XXX,                    XXX,                      Key_UpArrow,               Key_LeftBracket,       Key_RightBracket,    ___,
            ___,                     Key_LeftArrow,            Key_DownArrow,             Key_RightArrow,        ___,                 ___,
   ___,     ___,                     Key_Home,                 XXX,                       Key_End,               Key_Backslash,       Key_Pipe,
   ___,     ___,                     LSHIFT(Key_Minus),        ___,
   ___)
) // KEYMAPS(
...
void setup() {
  ...
  QUKEYS(
    kaleidoscope::plugin::Qukey(0, KeyAddr(2, 4), Key_LeftControl),    // F/Ctrl
    kaleidoscope::plugin::Qukey(0, KeyAddr(2, 11), Key_RightControl),  // J/Ctrl
  )
